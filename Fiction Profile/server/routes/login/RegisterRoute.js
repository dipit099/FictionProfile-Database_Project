...
router.post('/', upload.single('profilePicture'), async (req, res) => {
    ...
    try {
        ...
        // Here are some modifications needed
        // We need to first insert the people and then retrieve their id to upload the pic
        // So it is best to just have the upload pic functionality for Account edit section
